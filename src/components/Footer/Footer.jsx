...
const Footer = () => {
    ...
    return (
        <footer className={`${(theme === "dark") ? 'max-w-[5000px] mx-auto bg-black' : 'max-w-[5000px] mx-auto bg-fuchsia-100'}`}>
            {/* Footer Links Section */}
            <div className="pb-12 footer text-base-content p-10 pt-16 justify-evenly">
                {/* Explore Links */}
                <nav className="items-center flex flex-col">
                    <h6 className=" text-xl pb-3 text-fuchsia-700">Kawan</h6>
                ...
                <div className="items-center flex flex-col lg:mx-0 mx-auto">
                    <h6 className=" text-xl pb-3 text-fuchsia-700">Contact Us</h6>
                ...
                <div className="items-center flex flex-col lg:mx-0 mx-auto my-auto">
                    <h6 className=" text-xl pb-3 text-fuchsia-700">Follow Us</h6>
