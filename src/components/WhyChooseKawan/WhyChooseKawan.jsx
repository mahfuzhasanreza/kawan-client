...
const WhyChooseKawan = () => {
    return (
        <div className="pb-48 bg-base-200 py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {/* Card 1 */}
                    <div className="bg-white rounded-lg shadow-lg p-6 text-center transition-transform duration-300 hover:scale-105 hover:bg-red-100">
                        <img
                            src={chatbotImg}
                            alt="Kawan Chatbot"
                            className="w-fit h-20 mx-auto mb-4 animate-fadeIn"
                        />
